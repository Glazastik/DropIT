 ...
 */
public class AppleTile extends GameTile {
	...
	public AppleTile(int score) {
		this(new Color(255, 100, 0), new Color(255, 0, 0), 2.0);
		this.score = score;
	}
	 ...
	 */
	public AppleTile(final Color fillColor) {
	 ...
	 *            the color of the interior of the circle.
	 */
	public AppleTile(final Color strokeColor, final Color fillColor) {
	...
	public void draw(final Graphics g, final int x, final int y,
		...
		if(score < 10) {
			g2.drawString(""+score, x+d.width/2-4, y+d.height/2+5);
		} else {
			g2.drawString(""+score, x+d.width/2-8, y+d.height/2+5);
		}
	}
}